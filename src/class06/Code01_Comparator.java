...
//			return 0;
	...
	public static void main(String[] args) {
		...
		Arrays.sort(students , ((o1, o2) -> { return  o1.id != o2.id ? o1.id - o2.id : o1.age - o2.age;}));
		int[] sun = new int[]{1,2,4,5,6};
		Arrays.sort(sun ); //果然 这种int的逆序 就可以用先排序，然后在逆序遍历就好！
		...
		//注意在添加时，通过比较id来更新结构的，所以一样的id，加入时是更新，而不是添加！
